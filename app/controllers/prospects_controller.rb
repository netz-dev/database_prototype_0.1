class ProspectsController < ApplicationController
  layout "layouts/prospects/application"
  ...
  private
    ...
    def prospect_params
      params.require(:prospect).permit(:client_id, :campaign_id, :prospect_type, :prospect_status, :first_name, :last_name, :email, :phone_number, :mobile_number, :branch_location)
    end
end
